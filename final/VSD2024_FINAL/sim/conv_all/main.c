...
/* EPU data address */
  ...
  /* FC0 */
    // w32 data address
    extern unsigned int __w32_FC0_start;
    extern unsigned int __w32_FC0_end;
    extern unsigned int __w32_FC0_data_in_dram_start;
    // bias data address
    extern unsigned int __bias_FC0_start;
    extern unsigned int __bias_FC0_end;
    extern unsigned int __bias_FC0_data_in_dram_start;
    // param data address 
    extern unsigned int __param_FC0_start;
    extern unsigned int __param_FC0_end;
    extern unsigned int __param_FC0_data_in_dram_start;
...
/* FC0 -----------------------------------------------------------------------*/
  ...
  *epu_ctrl_addr = 0x1 | (epu_mode << 1); ///???
  ...
  dma_move(&__out8_FC2_start, &_test_start, quantity);
