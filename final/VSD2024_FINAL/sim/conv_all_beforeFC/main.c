...
/* EPU data address */
  ...
  /* Pool1 */
    // param data address 
    extern unsigned int __param_pool1_start;
    extern unsigned int __param_pool1_end;
    extern unsigned int __param_pool1_data_in_dram_start;

    // output data address 
    extern unsigned int __out8_FC2_start;
    extern unsigned int __out8_FC2_end;
...
/* pool1 ---------------------------------------------------------------------*/
  // Move param data
  quantity = (&__param_pool1_end - &__param_pool1_start) - 1;
  dma_move(&__param_pool1_data_in_dram_start, &__param_conv0_start, quantity);
...
// /* FC0 -----------------------------------------------------------------------*/
//   // Move param data
//   quantity = (&__param_FC0_end - &__param_FC0_start) - 1;
//   dma_move(&__param_FC0_data_in_dram_start, &__param_conv0_start, quantity);
//   // Move w2 data
//   quantity = (&__w32_FC0_end - &__w32_FC0_start) - 1;
//   dma_move(&__w32_FC0_data_in_dram_start, &__w2_conv0_start, quantity);
//   // Move bias data
//   quantity = (&__bias_FC0_end - &__bias_FC0_start) - 1;
//   dma_move(&__bias_FC0_data_in_dram_start, &__bias_conv0_start, quantity);
...
// // /* FC1 -----------------------------------------------------------------------*/
//   // Move param data
//   quantity = (&__param_FC1_end - &__param_FC1_start) - 1;
//   dma_move(&__param_FC1_data_in_dram_start, &__param_conv0_start, quantity);
//   // Move w2 data
//   quantity = (&__w32_FC1_end - &__w32_FC1_start) - 1;
//   dma_move(&__w32_FC1_data_in_dram_start, &__w2_conv0_start, quantity);
//   // Move bias data
//   quantity = (&__bias_FC1_end - &__bias_FC1_start) - 1;
//   dma_move(&__bias_FC1_data_in_dram_start, &__bias_conv0_start, quantity);
...
// // /* FC2 -----------------------------------------------------------------------*/
//   // Move param data
//   quantity = (&__param_FC2_end - &__param_FC2_start) - 1;
//   dma_move(&__param_FC2_data_in_dram_start, &__param_conv0_start, quantity);
//   // Move w2 data
//   quantity = (&__w32_FC2_end - &__w32_FC2_start) - 1;
//   dma_move(&__w32_FC2_data_in_dram_start, &__w2_conv0_start, quantity);
//   // Move bias data
//   quantity = (&__bias_FC2_end - &__bias_FC2_start) - 1;
//   dma_move(&__bias_FC2_data_in_dram_start, &__bias_conv0_start, quantity);
...
//   asm("wfi");
  ...
  quantity = (&__out8_FC2_end - &__out8_FC2_start) - 1;
