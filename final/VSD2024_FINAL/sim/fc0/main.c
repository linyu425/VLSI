...
int main(void){
    ...
    // self connect W32 data address
    extern unsigned int __w32_start;
    extern unsigned int __w32_end;
    extern unsigned int __w32_data_in_dram_start;
    ...
    // Move W32 data
    quantity = (&__w32_end - &__w32_start) - 1;
    dma_move(&__w32_data_in_dram_start, &__w32_start, quantity);
    // Move bias data
